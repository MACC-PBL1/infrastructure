###############################################
# VARIABLES - API GW -> ALB -> Microservices -> Aurora
###############################################
...
variable "allowed_ssh_cidr" {
  description = "CIDR blocks allowed for SSH (restrict this in production)"
  type        = list(string)
  default     = ["0.0.0.0/0"]
}
...
variable "db_master_password" {
  description = "Master password for Aurora (set in terraform.tfvars)"
  type        = string
  sensitive   = true
}
