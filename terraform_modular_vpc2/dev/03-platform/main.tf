...
module "secrets" {
  ...
  secrets = {
    # ============================================
    # SECRETOS REALES (credenciales sensibles)
    # ============================================
    
    # JWT Secret para autenticación de microservicios
    "/popbl-grupo1/dev/auth/jwt_secret" = {
      description = "JWT secret key for microservices authentication"
      value       = "super-secret-jwt-key-change-me-in-production-2026"
    }
    
    # API Key interna para comunicación entre microservicios
    "/popbl-grupo1/dev/auth/api_key" = {
      description = "Internal API key for microservices communication"
      value       = "api-key-internal-microservices-secure-2026"
    }
    
    # Contraseña para servicio de autenticación
    "/popbl-grupo1/dev/auth/service_password" = {
      description = "Password for Auth-Log microservice"
      value       = "auth-log-secure-password-2026"
    }
    
    # Secret para RabbitMQ
    "/popbl-grupo1/dev/rabbitmq/admin_password" = {
      description = "RabbitMQ admin password"
      value       = "rabbitmq-admin-secure-pass-2026"
    }
    
    # Secret para Consul
    "/popbl-grupo1/dev/consul/gossip_key" = {
      description = "Consul gossip encryption key"
      value       = "consul-gossip-encryption-key-2026"
    }
    
    # ============================================
    # CONFIGURACIÓN (nombres de recursos)
    # ============================================
